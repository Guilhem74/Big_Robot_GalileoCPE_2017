...
Consigne Consigne102(1248,602,-48);
...
Consigne Consigne792(Pince_H,TIMEOUT_SERVO,Pince_H_Serre,&Consigne100);
Consigne Consigne701(1589,550,-75,TIMEOUT_DEPLACEMENT,&Consigne792);
Consigne Consigne111(Pince_H,TIMEOUT_SERVO,Pince_H_Pousse,&Consigne701);

Consigne Consigne99(1589,580,-75,TIMEOUT_DEPLACEMENT,&Consigne111);
Consigne Consigne98(968,362,-71,TIMEOUT_DEPLACEMENT,&Consigne99);
...
Consigne Consigne970(Chargeur_Cylindre,1000,Chargeur_UP,&Consigne98);
...
Consigne Consigne97(Chargeur_Cylindre,1000,Chargeur_UP,&Consigne910);
...
Consigne Consigne601(1165,625,-45,TIMEOUT_DEPLACEMENT,&Consigne692);
Consigne Consigne750(Pince_H,TIMEOUT_SERVO,Pince_H_Pousse,&Consigne601);

Consigne Consigne6000(1104,536,-43,TIMEOUT_DEPLACEMENT,&Consigne750);

...
Consigne Consigne63(Pince_V,vitesse_servo,Pince_V_DOWN,&Consigne64);
Consigne Consigne62(Pince_V,vitesse_servo,Pince_V_Bourrage,&Consigne63);
Consigne Consigne61(Pince_V,vitesse_servo,Pince_V_DOWN,&Consigne62);
Consigne Consigne60(Chargeur_Cylindre,1000,Chargeur_UP,&Consigne61);

Consigne Consigne59(Pince_V,vitesse_servo,Pince_V_DOWN,&Consigne60);
Consigne Consigne58(Pince_V,vitesse_servo,Pince_V_Bourrage,&Consigne59);
Consigne Consigne57(Pince_V,vitesse_servo,Pince_V_DOWN,&Consigne58);
Consigne Consigne56(Chargeur_Cylindre,1000,Chargeur_UP,&Consigne57);


Consigne Consigne55(Chargeur_Cylindre,1000,Chargeur_UP,&Consigne56);
Consigne Consigne54(Pince_V,vitesse_servo,Pince_V_DOWN,&Consigne55);
Consigne Consigne53(Pince_V,vitesse_servo,Pince_V_Bourrage,&Consigne54);
Consigne Consigne52(Pince_H,vitesse_servo,Pince_H_Serre,&Consigne53);
Consigne Consigne51(Pince_V,vitesse_servo,Pince_V_DOWN,&Consigne52);
Consigne Consigne50(Pince_H,vitesse_servo,Pince_H_Gauche_Desserre,&Consigne51);
Consigne Consigne49(Pince_H,vitesse_servo,Pince_H_Droite_Desserre,&Consigne50);
Consigne Consigne48(Pince_V,vitesse_servo,Pince_V_UP,&Consigne49);
Consigne Consigne47(Bras,1000,Bras_Retracte,&Consigne48);
Consigne Consigne46(Pince_H,vitesse_servo,Pince_H_Serre,&Consigne47);
Consigne Consigne45(Bras,vitesse_servo,Bras_Pousse,&Consigne46);
Consigne Consigne44(Pince_H,vitesse_servo,Pince_H_Pousse,&Consigne45);
Consigne Consigne43(Pince_V,vitesse_servo,Pince_V_DOWN,&Consigne44);



Consigne Consigne42(Chargeur_Cylindre,1000,Chargeur_UP,&Consigne43);
Consigne Consigne41(Pince_V,vitesse_servo,Pince_V_DOWN,&Consigne42);
Consigne Consigne40(Pince_V,vitesse_servo,Pince_V_Bourrage,&Consigne41);
Consigne Consigne39(Pince_H,vitesse_servo,Pince_H_Serre,&Consigne40);
Consigne Consigne38(Pince_V,vitesse_servo,Pince_V_DOWN,&Consigne39);
Consigne Consigne37(Pince_H,vitesse_servo,Pince_H_Gauche_Desserre,&Consigne38);
Consigne Consigne36(Pince_H,vitesse_servo,Pince_H_Droite_Desserre,&Consigne37);
Consigne Consigne35(Pince_V,vitesse_servo,Pince_V_UP,&Consigne36);
Consigne Consigne34(Bras,1000,Bras_Retracte,&Consigne35);
Consigne Consigne33(Pince_H,vitesse_servo,Pince_H_Serre,&Consigne34);
Consigne Consigne32(Bras,vitesse_servo,Bras_Pousse,&Consigne33);
Consigne Consigne31(Pince_H,vitesse_servo,Pince_H_Pousse,&Consigne32);
Consigne Consigne30(Pince_V,vitesse_servo,Pince_V_DOWN,&Consigne31);


Consigne Consigne29(Chargeur_Cylindre,1000,Chargeur_UP,&Consigne30);
Consigne Consigne28(Pince_V,vitesse_servo,Pince_V_DOWN,&Consigne29);
Consigne Consigne27(Pince_V,vitesse_servo,Pince_V_Bourrage,&Consigne28);
Consigne Consigne26(Pince_H,vitesse_servo,Pince_H_Serre,&Consigne27);
Consigne Consigne25(Pince_V,vitesse_servo,Pince_V_DOWN,&Consigne26);
Consigne Consigne24(Pince_H,vitesse_servo,Pince_H_Gauche_Desserre,&Consigne25);
Consigne Consigne23(Pince_H,vitesse_servo,Pince_H_Droite_Desserre,&Consigne24);
Consigne Consigne22(Pince_V,vitesse_servo,Pince_V_UP,&Consigne23);
...
Consigne Consigne12(Pince_V,vitesse_servo,Pince_V_DOWN,&Consigne13);
Consigne Consigne11(Pince_H,vitesse_servo,Pince_H_Gauche_Desserre,&Consigne12);
Consigne Consigne10(Pince_H,vitesse_servo,Pince_H_Droite_Desserre,&Consigne11);
Consigne Consigne9(Pince_V,vitesse_servo,Pince_V_UP,&Consigne10);
Consigne Consigne8(Bras,1500,Bras_Retracte,&Consigne9);
Consigne Consigne7(Pince_H,vitesse_servo,Pince_H_Serre,&Consigne8);
Consigne Consigne6(Bras,vitesse_servo,Bras_Pousse,&Consigne7);
Consigne Consigne5(Pince_H,vitesse_servo,Pince_H_Pousse,&Consigne6);
Consigne Consigne4(Pince_V,vitesse_servo,Pince_V_DOWN,&Consigne5);
Consigne Consigne3(170,1310,95,&Consigne4);
Consigne Consigne2(90,1070,90,&Consigne3);
Consigne Consigne1(Pince_V,100,Pince_V_UP,&Consigne2);
